package com.dashan.gallery.ui.main.latest
...
import com.dashan.gallery.ui.ItemDetailActivity
import com.dashan.gallery.ui.ItemDetailFragment

import com.dashan.gallery.R
import com.dashan.gallery.entity.CoverEntity
import com.dashan.gallery.utils.ScreenUtils
...
class LatestFragment : Fragment() {
    ...
    private var latestViewModel: LatestViewModel? = null
...
//                });
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Thread(Runnable {
            try {
                val js = Jsoup.connect("https://wallhaven.cc/latest?page=1").get()
                val body = js.body()
