...
public final class StatusBarUtil {
    ...
    private static final int FAKE_STATUS_BAR_VIEW_ID = R.id.lib_base_statusbarutil_fake_status_bar_view;
    private static final int FAKE_TRANSLUCENT_VIEW_ID = R.id.lib_base_statusbarutil_translucent_view;
...
//            }
    ...
    public static void setLightMode(Activity activity) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            activity.getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR | View.SYSTEM_UI_FLAG_VISIBLE);
        }
    }
...
//        int systemUiVisibility = window.getDecorView().getSystemUiVisibility();
    ...
    private static void setTranslucentView(ViewGroup container, @FloatRange(from = 0.0, to = 1.0) float alpha) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            View translucentView = container.findViewById(R.id.lib_base_translucent_view);
            if (translucentView == null) {
                translucentView = new View(container.getContext());
                translucentView.setId(R.id.lib_base_translucent_view);
